      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          <div className="bg-dark-800 rounded-lg p-8 border border-gray-700 hover:border-neon-green transition-colors duration-300">
            ...
            <p className="text-black dark:text-gray-400 leading-relaxed mb-4">
          ...
          <div className="bg-dark-800 rounded-lg p-8 border border-gray-700 hover:border-neon-green transition-colors duration-300">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-2">🤝 Comunidade</h3>
                <p className="text-black dark:text-gray-400 text-sm">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-2">❤️ Paixão</h3>
                <p className="text-black dark:text-gray-400 text-sm">
        ...
        {/* Call to Action */}
        <div className="text-center mt-12 p-8 bg-gradient-to-r from-card to-secondary rounded-lg border border-neon-green">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/Contato"
              className="bg-neon-green text-primary-foreground px-8 py-3 rounded-lg font-semibold hover:opacity-90 transition-all duration-300"
            >
              Visite Nossa Loja
            </a>
            <a
              ...
              className="border-2 border-neon-green text-neon-green px-8 py-3 rounded-lg font-semibold hover:bg-neon-green hover:text-primary-foreground transition-all duration-300"
            >
              Siga no Instagram
            </a>
          </div>
