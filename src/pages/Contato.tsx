          ...
          <div className="bg-dark-800 rounded-lg p-8 border border-gray-700 hover:border-neon-green transition-colors duration-300">
            <div className="text-center">
              ...
              <button
                ...
                className="bg-green-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-600 transition-colors duration-300 w-full"
              >
                Abrir WhatsApp
              </button>
            </div>
...
{/*              </div>*/}
        ...
        <div className="mt-12 bg-dark-800 rounded-lg p-8 border border-gray-700">
          ...
          <div className="space-y-4">
            ...
            <div className="border-b border-gray-600 pb-4">
              <h4 className="font-semibold text-white mb-2">🔄 Posso trocar/devolver produtos?</h4>
              <p className="text-gray-400 text-sm">
            ...
            <div>
              <h4 className="font-semibold text-white mb-2">💳 Quais formas de pagamento vocês aceitam?</h4>
              <p className="text-gray-400 text-sm">
