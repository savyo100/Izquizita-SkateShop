...
const CardProduto = ({ id, nome, preco, imagem, descricao, tipo }: CardProdutoProps) => {
  ...
  return (
    <div className="bg-dark-800 dark:bg-dark-800 bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:scale-105 group border border-gray-200 dark:border-gray-700">
      ...
      <div className="p-4">
        <h3 className="text-lg font-semibold text-white dark:text-white text-gray-800 mb-1 group-hover:text-neon-green transition-colors duration-300">
          {nome}
        </h3>
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className="bg-neon-green text-black px-4 py-2 rounded-md font-medium hover:bg-white dark:hover:bg-white hover:bg-gray-100 hover:shadow-lg transition-all duration-300 hover:scale-105"
          >
            Comprar
          </button>
        </div>
